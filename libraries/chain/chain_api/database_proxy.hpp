...
public:
    ...
    virtual int32_t walk(void *db, int32_t tp, int32_t index_position);
    ...
    virtual int32_t find(void *db, int32_t tp, int32_t index_position, char *raw_data, size_t size, char **out, size_t *out_size);

    virtual int32_t lower_bound(void *db, int32_t tp, int32_t index_position, char *raw_data, size_t size, char **out, size_t *out_size);
    virtual int32_t upper_bound(void *db, int32_t tp, int32_t index_position, char *raw_data, size_t size, char **out, size_t *out_size);
